...
def get(url):
    req=urllib.request.Request(url,headers={'User-Agent':'fpl-player-pool/1.3'})
...
def main():
    ...
    for p in b['elements']:
        ...
        # Future schedule congestion stays a small club-level planning penalty; immediate risk is player-minute weighted.
