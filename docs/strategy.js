...
function loadDecisionJournal(){
  ...
  if(!document.querySelector('link[data-decision-journal]')){
    const l=document.createElement('link');l.rel='stylesheet';l.href='decision-history.css?v=20260826-1414';l.dataset.decisionJournal='1';document.head.appendChild(l);
  }
  if(!document.querySelector('script[data-decision-journal-v4]')){
    const s=document.createElement('script');s.src='decision-journal-v4.js?v=20260826-1414';s.dataset.decisionJournalV4='1';document.body.appendChild(s);
  }
}
